<div class="container-fluid">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <a href="<?php echo base_url();?>index.php/Pendidik/Nilai_peserta" class="btn btn-info pull-right">Kembali</a>

            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="<?php echo base_url(); ?>index.php/Pendidik/Nilai_peserta/simpan">
              <div class="box-body">
