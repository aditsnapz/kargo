...
<div class="container-fluid">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <a href="<?php echo base_url();?>index.php/Bendahara/Absensibendahara" class="btn btn-info pull-right">Kembali</a>

            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="<?php echo base_url(); ?>index.php/Bendahara/Absensibendahara/simpan" >
              <div class="box-body">
               <div class="form-group">
                ...
                <div class="form-group">
                  <label  class="col-md-2 control-label">Nama Bendahara</label>
