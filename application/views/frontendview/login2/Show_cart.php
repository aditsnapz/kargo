		...
		<table class="table table-bordered table-striped table-hover">
			...
			<tfoot>
				<tr>
					...
					<td align="right" name="total"><?= number_format($this->cart->total(),0,',','.'); ?></td>
				</tr>
			</tfoot>
		</table>
		<div align="center">
			<?= anchor('Frontend2/clear_cart','Clear Cart',['class'=>'btn btn-danger']) ?>
			<?= anchor('Frontend2/our_perfume','Continue Shopping',['class'=>'btn btn-primary']) ?>
			<?= anchor('Frontend2/order','Check Out',['class'=>'btn btn-success','POST']) ?>
		</div>
                    <!-- cta end -->
