...
<head>
  ...
  <!--<link href="<?php echo base_url(); ?>file/bootstrap/css/bootstrap-theme.css" rel="stylesheet">-->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b> DA Cargo</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <?php $this->load->view('Pim/side_menupimpin'); ?>
...
<script src="<?php echo base_url(); ?>file/sweet/dist/sweetalert.min.js"></script>
 <script  src="<?php echo base_url(); ?>file/bootstrap/js/ckeditor/ckeditor.js"></script>
