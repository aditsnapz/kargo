...
$this->fpdf->Text(6.3,1,'ABSEN SELURUH BENDAHARA');//posisi,ukuran 1 paling besar selebihnya makin kecil
...
$this->fpdf->Ln();
$query=$this->model_pegawai->absenbendahara();
...
$this->fpdf->Output('Absen_Bendahara','I');
