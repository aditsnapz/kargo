...
class Absensi1 extends CI_Controller {

	public function index()
	{
		$this->model_security->getsecurity();
		$isi['content']	='Tbendahara/absensi/tampilan_absensi';
	...
	public function edit(){
			$this->model_security->getsecurity();
			$this->load->model('model_pegawai');
			$isi['content']='Tbendahara/absensi/form_editabsensi';
			$isi['judul'] 	='Data Pendidik';
			$isi['view'] 	='absesni pendidik';
			$isi['menu'] 	= 'Pendidik';
			$isi['submenu'] = 'absen';
