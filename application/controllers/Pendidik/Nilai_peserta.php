...
class Nilai_peserta extends CI_Controller {
	...
	public function index()
	{
		...
		$isi['content']	='Pendidik/tampilan_nilaipeserta';
	...
	public function tambah(){
		$this->model_security->getsecurity();
		$this->load->model('Model_nilai');
		$isi['content']	='Pendidik/nilai_peserta/form_tambahnilai';
	...
	public function tambahjeans(){
		$this->model_security->getsecurity();
		$this->load->model('Model_nilai');
		$isi['content']	='Pendidik/nilai_peserta/form_tambahjeans';
		$isi['judul'] 	='Form Peserta';
		$isi['view'] 	='Tampilan Form Tambah';
		$isi['menu'] 	= 'Nilai Peserta';
		$isi['submenu'] = 'Tambah';
	...
	public function tambahkemeja(){
		$this->model_security->getsecurity();
		$this->load->model('Model_nilai');
		$isi['content']='Pendidik/nilai_peserta/form_tambahkemeja';
		$isi['judul'] 	='Form Peserta';
		$isi['view'] 	='Tampilan Form Tambah';
		$isi['menu'] 	= 'Nilai Peserta';
		$isi['submenu'] = 'Tambah';
		...
		redirect('Pendidik/Nilai_peserta');
	}
		public function edit(){
			$this->model_security->getsecurity();
			$this->load->model('Model_nilai');
			$isi['content']='Pendidik/nilai_peserta/form_editnilai';
			$isi['judul'] 	='Form Peserta';
			$isi['view'] 	='Tampilan Form Tambah';
			$isi['menu'] 	= 'Nilai Peserta';
			$isi['submenu'] = 'Tambah';
